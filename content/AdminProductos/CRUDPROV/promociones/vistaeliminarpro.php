...
<h1 class="box-container2">"Esta seguro de eliminar la promoción?"</h1>
<h2 style="transform: translate(18%, 40%); font-size: 25px;;" >Una vez eliminada no habrá forma de recuperarla.</h2><br>
 
    <div ><form  action="modificarpro.php" style="transform: translate(30%,10%); font-size: 25px;;"
     method="GET" >

     <input type="hidden" name="promocion"  value="0" style="background-color: #acf5ac; border-radius: 10px; width: 25%; font-size: 25px;">
     <br></br>
